...
<div class="sidebar">
    <h1>Propriétaire</h1>
    <a href="${pageContext.request.contextPath}/Immeuble" target="contentFrame">🏢 Mes Immeubles</a>
    <a href="${pageContext.request.contextPath}/UniteLocation" target="contentFrame">🏠 Mes Unités</a>
...
<div class="content">
    ...
    <div class="welcome-content" id="welcomeContent">
        ...
        <p>Gérez vos immeubles et vos unités de location depuis cet espace dédié.</p>
    </div>
</div>
